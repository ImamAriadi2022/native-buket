...
const SatinScreen = ({ navigation }: any) => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.heroSection}>
        ...
        <Text style={styles.title}>Pashmina Satin</Text>
        <Text style={styles.description}>
          Hijab mewah dengan efek mengilap, cocok untuk tampilan elegan dan glamor.
        </Text>
      </View>
      ...
      <View style={styles.imageSection}>
        <View style={styles.imagePlaceholder}>
          ...
          <Text style={styles.imagePlaceholderSubtext}>Foto Pashmina Satin</Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.tagsContainer}>
          {['Satin Silk', 'Satin Velvet'].map((material, index) => (
      ...
      <View style={styles.section}>
        ...
        {[
          ...
          'Efek glossy yang cantik di kamera',
          'Banyak dipilih untuk acara formal',
          'Bisa dibentuk simple maupun dramatis'
        ].map((advantage, index) => (

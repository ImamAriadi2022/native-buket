...
const PlisketScreen = ({ navigation }: any) => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.heroSection}>
        ...
        <Text style={styles.title}>Pashmina Plisket</Text>
        <Text style={styles.description}>
          Hijab bergaya lipit-lipit kekinian yang langsung membentuk tanpa ribet.
        </Text>
      </View>
      ...
      <View style={styles.imageSection}>
        <View style={styles.imagePlaceholder}>
          ...
          <Text style={styles.imagePlaceholderSubtext}>Foto Pashmina Plisket</Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.tagsContainer}>
          {['Ceruty Plisket', 'Diamond Italiano'].map((material, index) => (
      ...
      <View style={styles.section}>
        ...
        {[
          'Lipatan rapi, langsung bentuk',
          'Tidak perlu setrika',
          'Ringan dan nyaman dipakai',
          'Cocok untuk gaya simple namun tetap trendi'
        ].map((advantage, index) => (

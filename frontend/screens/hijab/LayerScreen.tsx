...
const LayerScreen = ({ navigation }: any) => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.heroSection}>
        ...
        <Text style={styles.title}>Hijab Layer</Text>
        <Text style={styles.description}>
          Hijab bertumpuk dua atau lebih, memberikan kesan anggun dan elegan.
        </Text>
      </View>
      ...
      <View style={styles.imageSection}>
        <View style={styles.imagePlaceholder}>
          ...
          <Text style={styles.imagePlaceholderSubtext}>Foto Hijab Layer</Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.tagsContainer}>
          {['Ceruty Baby Doll', 'Sifon', 'Diamond Crepe'].map((material, index) => (
      ...
      <View style={styles.section}>
        ...
        {[
          'Tampil mewah dan feminin',
          'Cocok untuk acara resmi dan pesta',
          'Tersedia model instan atau non-instan',
          'Bisa dua layer depan & belakang atau diagonal'
        ].map((advantage, index) => (

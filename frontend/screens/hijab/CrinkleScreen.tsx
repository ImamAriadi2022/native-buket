...
const CrinkleScreen = ({ navigation }: any) => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.heroSection}>
        ...
        <Text style={styles.title}>Pashmina Crinkle</Text>
        <Text style={styles.description}>
          Hijab kekinian dengan tekstur kerut alami, simpel tanpa setrika.
        </Text>
      </View>
      ...
      <View style={styles.imageSection}>
        <View style={styles.imagePlaceholder}>
          ...
          <Text style={styles.imagePlaceholderSubtext}>Foto Pashmina Crinkle</Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.tagsContainer}>
          {['Crinkle Voal', 'Bubble Crepe'].map((material, index) => (
      ...
      <View style={styles.section}>
        ...
        {[
          'Tidak perlu disetrika (anti ribet)',
          'Ringan, jatuh, dan mudah dibentuk',
          'Tampil modis tanpa banyak usaha',
          'Cocok untuk mahasiswa, pekerja, atau hangout'
        ].map((advantage, index) => (

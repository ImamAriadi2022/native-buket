...
const PashminaVoalScreen = ({ navigation }: any) => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.heroSection}>
        ...
        <Text style={styles.title}>Pashmina Voal</Text>
        <Text style={styles.description}>
          Hijab yang ringan, tidak licin, dan mudah dibentuk — cocok untuk tampilan rapi dan stylish.
        </Text>
      </View>
      ...
      <View style={styles.imageSection}>
        <View style={styles.imagePlaceholder}>
          ...
          <Text style={styles.imagePlaceholderSubtext}>Foto Pashmina Voal</Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.tagsContainer}>
          {['Voal Premium (Katun + Polyester)'].map((material, index) => (
      ...
      <View style={styles.section}>
        ...
        {[
          'Tegak di dahi tanpa inner tambahan',
          'Mudah dibentuk dan tidak mudah lecek',
          'Cocok untuk gaya simple dan elegan',
          'Banyak pilihan warna pastel dan netral'
        ].map((advantage, index) => (
...
export default PashminaVoalScreen;

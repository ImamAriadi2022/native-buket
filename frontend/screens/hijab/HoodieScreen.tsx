  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.heroSection}>
        ...
        <Text style={styles.title}>Hijab Hoodie</Text>
        <Text style={styles.description}>
          Hijab dengan desain menyatu seperti tudung atau penutup kepala modern, simpel dan kekinian.
        </Text>
      </View>
      ...
      <View style={styles.imageSection}>
        <View style={styles.imagePlaceholder}>
          ...
          <Text style={styles.imagePlaceholderSubtext}>Foto Hijab Hoodie</Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.tagsContainer}>
          {['Jersey Premium', 'Katun', 'Rib Knit'].map((material, index) => (
      ...
      <View style={styles.section}>
        ...
        {[
          'Tidak perlu jarum atau peniti',
          'Nyaman dan cepat dipakai',
          'Menutup leher dan telinga',
          'Cocok untuk cuaca dingin atau tampilan sporty'
        ].map((advantage, index) => (

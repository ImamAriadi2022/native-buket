...
const KhimarScreen = ({ navigation }: any) => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.heroSection}>
        ...
        <Text style={styles.title}>Hijab Khimar</Text>
        <Text style={styles.description}>
          Hijab panjang menutupi dada hingga punggung atau bahkan lutut, tampil syar'i namun tetap stylish.
        </Text>
      </View>
      ...
      <View style={styles.imageSection}>
        <View style={styles.imagePlaceholder}>
          ...
          <Text style={styles.imagePlaceholderSubtext}>Foto Hijab Khimar</Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.tagsContainer}>
          {['Ceruty Baby Doll', 'Wolfis', 'Diamond Crepe'].map((material, index) => (
      ...
      <View style={styles.section}>
        ...
        {[
          'Jatuh dan flowy saat dipakai',
          'Bisa satu layer atau dua layer',
          'Tersedia model pet / non-pet',
          'Cocok dipadukan dengan gamis polos atau motif'
        ].map((advantage, index) => (
